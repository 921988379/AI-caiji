...
class WP_Caiji_DB
{
    public static function create_tables()
    {
        ...
        dbDelta("CREATE TABLE {$rules} (
            ...
            auto_tag_advanced TINYINT(1) NOT NULL DEFAULT 0,
            ...
            ai_rewrite_language VARCHAR(20) NOT NULL DEFAULT '',
        ...
        self::maybe_add_column($rules, 'auto_tag_advanced', "ALTER TABLE {$rules} ADD auto_tag_advanced TINYINT(1) NOT NULL DEFAULT 0");
        ...
        self::maybe_add_column($rules, 'ai_rewrite_language', "ALTER TABLE {$rules} ADD ai_rewrite_language VARCHAR(20) NOT NULL DEFAULT ''");
    }
